...
model_def_file='/home/deep/develop/image2text/neuraltalk/matlab_features_reference/deploy_features.prototxt';               
%model_file = '/home/karpathy/caffe2/models/vgg_ilsvrc_16/VGG_ILSVRC_16_layers.caffemodel';
model_file='/home/deep/develop/caffe/models/VGG_ILSVRC/VGG_ILSVRC_16_layers.caffemodel'
batch_size = 10;
...
root_path = '/home/deep/develop/image2text/neuraltalk/test_images/';
fs = textread([root_path 'task.txt'],'%s');
N = length(fs);
